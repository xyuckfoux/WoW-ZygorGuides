...
if ZGV:DoMutex("LevelingHLEGIONdhstart") then return end

ZygorGuidesViewer.GuideMenuTier = "LEG"

ZygorGuidesViewer:RegisterGuide("Zygor's Horde Leveling Guides\\Starter Guides\\Demon Hunter (98-100)",{
...
//VENGEANCE QUEST - END
	...
	step
		Enter Orgrimmar |goto 45.53,11.91 > 2000
