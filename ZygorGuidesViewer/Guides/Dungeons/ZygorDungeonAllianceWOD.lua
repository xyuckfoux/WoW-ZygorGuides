...
|tip Look out for people targeted by Cackling Pyromaniacs if they are not interupted players targeted will take very high burst damage.
_All Roles_:
...
|tip Interupt Delilitating Fixation.
...
_Healer_:
|tip Watch the player targeted by Incinerating Breath or by Iron Reaver, these people will take a large amount of damage.
_All Roles_:
...
|tip Deathstalkers will be one of the adds that spawn during this phase they will target a random player and teleport on them then start casting a Consume Magic, This ability will do damage in a circle around the mob and interupt anyone casting inside the cirlce.
confirm
