...
ZygorGuidesViewer:RegisterGuide("GOLD\\Horde Daily Runs\\Saltstone Plate Set Transmog",{
	...
	maps={"Dire Maul","Thousand Needles","Feralas"},
		...
		label "DM4"
			...
			_
			Click here for an alternative farming route |confirm |next "pvph"
			modelnpc Zevrim Thornhoof##11490 
		step
		label "DM5"	
			...
			_
			Click here for an alternative farming route |confirm |next "pvph"
			modelnpc Alzzin the Wildshaper##11492
		step
		label "DME1"
		...
		label "pvph"
			...
			modelnpc Grimtotem Marauder##39949
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Horde Daily Runs\\Bloodscale Plate Set Transmog",{
	...
	label "HR1"
		...
		modelnpc Watchkeeper Gargolmar##17306
	step
		...
		_
		Click here if you want to sell what you have |confirm |next "sell"
		modelnpc Omor the Unscarred##17308
	step
		...
		_
		Click here if you want to sell what you have |confirm |next "sell"
		modelnpc Nazan##17307
		modelnpc Vazruden##17537
	step
	label "BF1"
	...
	step
		...
		_
		Click here if you want to sell what you have |confirm |next "sell"
		modelnpc  Keli'dan the Breaker##17377
	step
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Horde Daily Runs\\Resilient Cloth Set Transmog",{
	...
	step
		...
		modelnpc Hatefury Felsworn##4672
		modelnpc Hatefury Betrayer##4673
		modelnpc Hatefury Hellcaller##4675
		modelnpc Hatefury Shadowstalker##4674
		modelnpc Gritjaw Basilisk##4728
		modelnpc Scorpashi Snapper##4696
		modelnpc Starving Bonepaw##4689
		Click here to sell |confirm |next sell
		_
