...
ZygorGuidesViewer:RegisterInclude("H_Garrison_CommandTable",[[
		...
		click Command Table |goto Frostwall/0 39.7,54.8 |only if garrisonlvl(3) and not hasbuilding(207)
		click Command Table |goto Frostwall/0 39.1,56.2 |only if garrisonlvl(3) and hasbuilding(207)
]])

ZygorGuidesViewer:RegisterInclude("H_Garrison_FleetCommandTable",[[
		clicknpc Fleet Command Table##94398 |goto Frostfire Ridge/0 42.0,71.0 |only if garrisonlvl(3) and not hasbuilding(207)
		|tip It looks like a round wooden table with a map on it. |only if garrisonlvl(3) and not hasbuilding(207)
		clicknpc Fleet Command Table##94398 |goto Frostwall/0 38.6,54.8 |only if garrisonlvl(3) and hasbuilding(207)
		|tip It looks like a round wooden table with a map on it. |only if garrisonlvl(3) and hasbuilding(207)
]])
...
-----------------------------------
--Small--
ZygorGuidesViewer:RegisterInclude("H_Garrison_Small_Building",[[
...
ZygorGuidesViewer:RegisterInclude("H_Garrison_Finalize_Small",[[
		click Finalize Garrison Plot |goto Frostwall/0 52.3,36.8 |only if ZGV.Garrison_GetBuildingLocation("%building%")==18
		click Finalize Garrison Plot |goto Frostwall/0 49.3,34.8 |only if ZGV.Garrison_GetBuildingLocation("%building%")==19
		click Finalize Garrison Plot |goto Frostwall/0 52.0,40.0 |only if ZGV.Garrison_GetBuildingLocation("%building%")==20
		click Finalize Garrison Plot |goto Frostwall/0 52.3,36.8 |only if default
		|tip It looks like a huge floating scroll in a column of yellow light.
]])


--Medium--
ZygorGuidesViewer:RegisterInclude("H_Garrison_Medium_Building",[[
...
ZygorGuidesViewer:RegisterInclude("H_Garrison_Finalize_Medium",[[
		click Finalize Garrison Plot |goto Frostwall/0 51.7,56.8 |only if ZGV.Garrison_GetBuildingLocation("%building%")==22
		click Finalize Garrison Plot |goto Frostwall/0 56.6,29.2 |only if ZGV.Garrison_GetBuildingLocation("%building%")==25
		click Finalize Garrison Plot |goto Frostwall/0 51.7,56.8 |only if default
		|tip It looks like a huge floating scroll in a column of yellow light.
]])


--Large--
ZygorGuidesViewer:RegisterInclude("H_Garrison_Large_Building",[[
...
ZygorGuidesViewer:RegisterInclude("H_Garrison_Finalize_Large",[[
		click Finalize Garrison Plot |goto Frostwall/0 58.4,48.5 |only if ZGV.Garrison_GetBuildingLocation("%building%")==23 and garrisonlvl(1)
		click Finalize Garrison Plot |goto Frostwall/0 58.1,48.4 |only if ZGV.Garrison_GetBuildingLocation("%building%")==23 and garrisonlvl() >= 2
		click Finalize Garrison Plot |goto Frostwall/0 59.1,36.9 |only if ZGV.Garrison_GetBuildingLocation("%building%")==24
		click Finalize Garrison Plot |goto Frostwall/0 58.4,48.5 |only if default
		|tip It looks like a huge floating scroll in a column of yellow light.
]])

--Default--
ZygorGuidesViewer:RegisterInclude("H_Garrison_Fishing_Finalize",[[
		click Finalize Garrison Plot |goto Frostwall/0 39.2,71.5 |only if garrisonlvl() >= 2
		|tip It looks like a huge floating scroll in a column of yellow light. |only if garrisonlvl() >= 2
]])

ZygorGuidesViewer:RegisterInclude("H_Garrison_HerbGarden_Finalize",[[
		click Finalize Garrison Plot |goto Frostwall/0 44.6,81.2 |only if garrisonlvl() >= 2
		|tip It looks like a huge floating scroll in a column of yellow light. |only if garrisonlvl() >= 2
]])

ZygorGuidesViewer:RegisterInclude("H_Garrison_FrostwallMines_Finalize",[[
		click Finalize Garrison Plot |goto Frostwall/0 62.6,72.3|only if garrisonlvl() >= 2
		|tip It looks like a huge floating scroll in a column of yellow light. |only if garrisonlvl() >= 2
]])
...
---//Garrison Campaign: The Sargerei Campaign\\---
	...
	step
		...
		collect 1 Sargerei Slippers##112893 |q Infiltrating the Sargerei##35187/1 |goto Shadowmoon Valley D/0 48.6,76.5
		collect 1 Sargerei Robe##112891 |q Infiltrating the Sargerei##35187/2 |goto Shadowmoon Valley D/0 48.6,76.5
		collect 1 Sargerei Cowl##112791 |q Infiltrating the Sargerei##35187/3 |goto Shadowmoon Valley D/0 48.6,76.5
	step
		use Sargerei Cowl##112791
		use Sargerei Disguise##112904
		Create and Put On A Sargerei Disguise |q Infiltrating the Sargerei##35187/4 |goto Shadowmoon Valley D/0 48.6,76.5
	step
	...
	stickystart "spear"
	step
		kill Eldermoss##81481 |q An Ancient Thread##35190/1 |goto Shadowmoon Valley D/0 45.4,73.8
	step
	label "spear"
		kill Shadowglen Thornshooter##81502+, Shadowglen Spitter##81637+
		collect 8 Wooden Spear##103994 |q Pesky Podlings##35188/1 |goto Shadowmoon Valley D/0 47.1,77.7
	stickystart "crystals"
	step
		click The Eredar Destiny##88388
		Read "The Eredar Destiny" |q The Word of Socrethar##35189/1 |goto Shadowmoon Valley D/0 51.4,75.7
	step
		click The Purpose of Unity##88389
		Read "The Purpose of Unity" |q The Word of Socrethar##35189/2 |goto Shadowmoon Valley D/0 50.1,72.5
	step
		click The Promise of Eternity##88390
		Read "The Promise of Eternity" |q The Word of Socrethar##35189/3 |goto Shadowmoon Valley D/0 50.8,79.7
	step
	label "crystals"
		click Felstorm Crystal##88370+
		|tip These can bef found inside the buildings or small tents in this area.
		Deastroy #6# Felstorm Crystals |q Shattering the Enemy##35191/1 |goto Shadowmoon Valley D/0 49.6,73.2
	step
		talk Anchorite Laanda##81530
	...
	step
		...
		kill Invokaz##81697 |q Facing Demons##35194/1 |goto Shadowmoon Valley D/0 46.1,80.6
	step
		clicknpc Demon Gate##88399
		Destroy the Demon Gate |q Facing Demons##35194/2 |goto Shadowmoon Valley D/0 46.3,80.6
	step
	...
	step
		...
		Confront Socrethar |q Socrethar's Fury##35195/1 |goto Shadowmoon Valley D/0 50.4,82.1
	step
		kill Soulbinder Zamaya##81858
		collect Sargerei Battle Plans |q Socrethar's Fury##35195/2 |goto Shadowmoon Valley D/0 50.7,82.4
	step
		talk Anchorite Laanda##81530
...
---//Garrison Campaign: Ring of Blood Campaign\\---
	...
	step
		kill Lug'dol##84675
		collect Lug'dol's Head##114976 |q How Tough Are You?##36220/1 |goto Nagrand D/0 64.4,22.6
	step
		clicknpc Lug'dol's Head##84750
		Present Lug'dol's Head |q How Tough Are You?##36220/2 |goto Nagrand D/0 56.9,19.2
	step
	...
	step
		...
		collect 50 Blood Stone##114996 |q Entry Fee##36221/1 |goto Nagrand D/0 58.5,18.5
	step
	...
	step
		...
		Win The Blood Championship |q The Champion of Blood##36222/2 |goto Nagrand D/0 56.1,13.8
	step
		talk Wodin the Troll-Servant##84784
...
---//Garrison Campaign: Darktide Roost Campaign\\---
	...
	step
		...
		Destroy #3# Shredders |q Shredder Suppressor##34353/1 |goto Shadowmoon Valley D/0 57.7,86.5
	step
		kill Darktide Engineer##78999+, Darktide Pilferer##78148+
		Slay #5# Pilferers |q Darktide Defender##34352/1 |goto Shadowmoon Valley D/0 57.7,86.5
		Slay #5# Engineers |q Darktide Defender##34352/2 |goto Shadowmoon Valley D/0 57.7,86.5
	step
	...
	step
		...
		Destroy #5# Unmanned Iron Shredders |q Dirty Rats##34355/1 |goto Shadowmoon Valley D/0 55.8,89.2
		modelnpc Unmanned Iron Shredder##78726
	step
		talk Rexxar##78258
	...
	step
		...
		Free the First Rylak |q Releasing Rylak##34365/1 |count 1 |goto 58.69,94.96
	step
		click Rylak Cage##229042
		Free the Second Rylak |q Releasing Rylak##34365/1 |count 2 |goto 59.5,95.8
	step
		click Rylak Cage##229042
		Free the Third Rylak |q Releasing Rylak##34365/1 |count 3 |goto 61.6,95.5
	step
		kill Assistant Fexfuse##78409 |q Downsizing the Darktide##34397/1 |goto 60.7,93.0
	step
		kill Captain Killrath##78410 |q Downsizing the Darktide##34397/2 |goto 62.43,93.93
	step
		kill Ra'ka Bloodspear##78475 |q Downsizing the Darktide##34397/3 |goto 59.25,99.04
	step
	...
	step
		...
		Free #5# Controlled Rylak Minds |q Free their Minds##34455/1 |goto 60.25,95.24
	step
		Click the _Quest Complete_ Box:
	...
	step
		...
		Ride Nisha |q Rylak Rescue##34450/1 |goto 58.14,93.89
	step
		kill Razz Ricketroz##78973 |q Rylak Rescue##34450/2 |goto 60.1,90.5
	step
...
---//Garrison Campaign: Iron Siegeworks Campaign\\---
	...
	step
		...
		Release the Drill Clutch |q I Know The Drill!##34035/1 |goto Frostfire Ridge/0 80.0,56.3
	step
		kill Kruk Ironjaw##78040 |q I Know The Drill!##34035/2 |goto Frostfire Ridge/0 80.6,57.0
	step
		kill Nakeeta Coldtalon##78041 |q I Know The Drill!##34035/3 |goto Frostfire Ridge/0 80.5,56.5
	step
		click Drill Clutch##3365
		Re-engage the Drill Clutch |q I Know The Drill!##34035/4 |goto Frostfire Ridge/0 80.0,56.3
	step
		talk Gazlowe##77928
	...
	step
		...
		collect Blackrock Cog##228733 |q Four Finger Discount##34041/1 |goto Frostfire Ridge/0 87.5,55.7
	step
		click Condensed Geyser Gas##3365
		collect Condensed Geyser Gas##228735 |q Four Finger Discount##34041/2 |goto Frostfire Ridge/0 87.3,53.1
	step
		_Go up_ the path |goto Frostfire Ridge/0 85.7,55.8 < 10
		click Carbonfrost Flamecore##3365
		collect Carbonfrost Flamecore##228736 |q Four Finger Discount##34041/3 |goto Frostfire Ridge/0 85.2,58.3
	step "siegeparts"
		click Siege Parts##3365+
		|tip These can be found all around the Iron Siegeworks.
		Inspect #5# Siege Parts |q Maker's Mark##34040/1 |goto Frostfire Ridge/0 86.7,55.5
	step
		Next to you:
		talk Gazlowe##77928
	...
	step
		Find Thaelin Darkanvil |q A Fellow Gearhead##34042/1 |goto Frostfire Ridge/0 88.4,49.4
	step
		Next to you:
		talk Gazlowe##77928
	...
	step
		...
		kill Overlord Blackhammer##77175 |q Wanted: Overlord Blackhammer##34039/1 |goto Frostfire Ridge/0 86.6,45.5
	step
		Next to you:
		talk Gazlowe##77928
	...
	step
		...
		Bring Gazlowe to the Roof |q Payment Due for Services Rendered##34078/1 |goto Frostfire Ridge/0 85.9,45.9
	step
		click Rocket Chicken XL##78392 |goto Frostfire Ridge/0 86.0,46.1 < 5
...
---//Garrison Campaign: Bloodmaul Compound Campaign\\---
	...
	step
		...
		collect Bloodmaul Slave Key##110664 |q Out of the Chains##34314/1 |goto Frostfire Ridge/0 52.7,18.4
	step
		click Bwu'ja's Shackle##181
		Unlock Bwu'ja's Shackle |q Out of the Chains##34314/2 |goto Frostfire Ridge/0 51.8,16.7
	step
		talk Shadow Hunter Bwu'ja##78659
	...
	step
		...
		collect Shadow Hunter's Glaive##110607 |q Gearing Up##34315/2 |goto Frostfire Ridge/0 47.7,18.8
	step
		click Ogre Chest##229415
		|tip It looks like a box with leather stretched over it.
		collect Shadow Hunter Garb##110606 |q Gearing Up##34315/1 |goto Frostfire Ridge/0 45.5,22.2
	step
		click Shadow Hunter's Mask##3365
		|tip It is on a small table outside the tower.
		Shadow Hunter's Mask |q Gearing Up##34315/3 |goto Frostfire Ridge/0 43.9,15.2
	step
		talk Shadow Hunter Bwu'ja##78659
	...
	step
		kill Grubnor Wargut##78003 |q The Shadow Gate##34381/1 |goto Frostfire Ridge/0 39.5,23.2
	step
	...
	step
		...
		Cleanse #10# Crazed Souls |q Cleansing the Souls##34469/1 |goto Frostfire Ridge/0 40.6,17.7
	step "totemsthatbind"
		click Borgal's Totem##3365+
		collect 5 Borgal's Totem##110378 |q The Totems That Bind##34318/1 |goto Frostfire Ridge/0 40.6,17.7
	step
		talk Orlana Strongbrow##78428
	...
	step
		...
		Place Borgal's Totems |q Soulgrinder Survivor##34319/1 |goto Frostfire Ridge/0 38.0,13.8
	step
		kill Borgal Doomfist##77997 |q Soulgrinder Survivor##34319/2 |goto Frostfire Ridge/0 38.0,13.8
	step
		talk Shadow Hunter Bwu'ja##78785
...
---//Garrison Campaign: Ours Is The Fury Campaign\\---
	...
	step
		...
		First Half of the Ritual Completed |q Eaters of the Elements##32980/1 |goto Frostfire Ridge/0 57.6,41.6
		Second Half of the Ritual Completed |q Eaters of the Elements##32980/2 |goto Frostfire Ridge/0 57.6,41.6
	step
		kill Flaming Goren##74352
		Rescue Child of the Fury |q Eaters of the Elements##32980/3 |goto Frostfire Ridge/0 57.6,41.6
	step
	...
	step
		...
		Rescue Kindler |q In the Shadow of Giants##32983/2 |goto Frostfire Ridge/0 70.1,27.5
	step
		clicknpc Flamrog##74589
		Rescue Flamerog |q In the Shadow of Giants##32983/1 |goto Frostfire Ridge/0 70.8,23.6
	step "mote"
		kill Burning Slagmaw##72348+, Vicious Acidmaw##76905+
		collect 10 Mote of Frostfire##102091 |q Eatercology##33444/1 |goto Frostfire Ridge/0 70.1,29.8
	step
		talk Draka##72230
	...
	step
		kill Kron##72631 |q Fury of Frostfire##32985/1 |goto Frostfire Ridge/0 70.2,39.1
	step
		talk Farseer Drek'Thar##74330
...
---//Garrison Campaign: Fall of Shattrath Campaign\\---
	...
	step
		...
		collect 100 Sargerei Insignia##113294 |q Reclaiming the City##35684/1 |goto Talador 44.2,37.8
	step
	...
	step
		...
		Challenge Socrethar |q Socrethar's Demise##35687/1 |goto Talador 42.3,33.0 < 7
		kill Socrethar##82662 |q Socrethar's Demise##35687/2 |goto Talador 41.6,32.4
	step
		_Ride_ up the elevator |goto Talador/0 47.4,44.0 < 15 |only if walking
		talk Lady Liadrin##76804
...
---//Garrison Campaign: Warlord's Council Campaign\\---
	...
	step
		...
		Discover the Iron Horde's Plans |q The Warlord's Council##35844/1 |goto Nagrand D/0 41.9,37.0
	step
	...
	step
		...
		Retrieve the Miniature War Machine |q Plans of War##35845/2 |goto 42.63,38.56
	step
		kill Packleader Vor'gash##83049 |q Putting Down the Packleader##35842/1 |goto Nagrand D/0 44.8,37.7
	step
		clicknpc Map of Tanaan Jungle##83563
		|tip It is located inside the hut next to the table.
		Retrieve the Map of Tanaan Jungle |q Plans of War##35845/3 |goto 45.85,36.70
	step
		clicknpc Scale Model of Gorgorek##83534
		|tip It is located inside the hut on the table.
		Retrieve the Scale Model of Gorgorek |q Plans of War##35845/1 |goto 43.24,34.21
	step
		...
		collect Frostfire Mission Orders##113492 |q Intercepting the Orders##35846/1 |goto Nagrand D/0 45.2,36.4
		collect Shadowmoon Mission Orders##113494 |q Intercepting the Orders##35846/2 |goto Nagrand D/0 45.2,36.4
		collect Spires of Arak Mission Orders##113493 |q Intercepting the Orders##35846/3 |goto Nagrand D/0 45.2,36.4
	step
		#include "H_Garrison_Rokhan"
...
---//Garrison Campaign: A Strike At The Heart Campaign\\---
	...
	label "strikeattheheart"
		...
		Find Dul'zak |q Garrison Campaign: Missing Grunt##36261/1 |goto Frostwall 63.6,44.6
	step
		Click the _Quest Complete_ Box:
		turnin Garrison Campaign: Missing Grunt##36261
		accept Where There Is Smoke...##36242
	step
		kill Akatha Blazeburn##84741 |q Where There Is Smoke...##36242/2 |goto Frostwall 72.6,49.1
	step
		kill Rag'sla Thunkblade##84738 |q Where There Is Smoke...##36242/1 |goto Frostwall 55.4,15.6
	step
		_Follow the path_ back |goto Frostwall/0 43.4,67.0 < 20
		kill Drek the Firecaller##84742 |q Where There Is Smoke...##36242/3 |goto Frostwall 44.6,84.4
	step
		#include "H_Garrison_WarmasterZog"
		turnin Where There Is Smoke...##36242
		accept A Stolen Heart##36248
	step
		kill Azuka Bladefury##84757 |q A Stolen Heart##36248/1 |goto Frostwall/0 52.1,36.1
	step
		#include "H_Garrison_WarmasterZog"
...
---//Garrison Campaign: Broken Precipice Campaign\\---
	...
	step
		...
		Unhook Greblin Fastfizzle |q Greblin Fastfizzle##35945/1 |goto Nagrand D 39.6,24.6
	step
		talk Greblin Fastfizzle##83686
	...
	step
		...
		collect Redtooth Necklace##113594 |q Preservation Capitalization##35970/1 |goto Nagrand D 37.9,25.6
	step
		...
		collect Ogre Bust##113603 |q Preservation Capitalization##35970/3 |goto Nagrand D 36.7,21.2
	step
		click Purpletooth Necklace##233554
		collect Purpletooth Necklace##113615 |q Preservation Capitalization##35970/2 |goto Nagrand D 35.7,18.9
	step "ogreonslaught"
		kill 3 Sledgebasher##83575+, Slave-Grinder##88187+, Arcanist Earthsmasher##83577+ |q Ogre Onslaught##35972/1 |goto Nagrand D/0 35.5,20.4
		kill 3 Defiant Drudge##83570+, Broken Drudge##83831+, Dominating Drudge##83640+ |q Ogre Onslaught##35972/2 |goto Nagrand D/0 35.5,20.4
	...
	step
		...
		Provoke Brokyo |q Brokyo Beatdown##35973/1 |goto 41.0,14.2
	step
		kill Brokyo##83655
		collect Brokyo's Ring##114121 |q Brokyo Beatdown##35973/2 |goto 41.0,14.4
	step
		talk Dizzy Sparkshift##76508
...
---//Garrison Campaign: Heart of the Breakers Campaign\\---
	...
	step
		...
		collect O'rok's Head##110231 |q Ambushing the Enemy##34336/2 |goto Gorgrond 40.4,40.2
	step
	...
	step "caravanshipments"
		click Caravan Shipment##229018+
		|tip They look like large stacks of grey crates.
		collect 5 Caravan Shipment##110230 |q Ambushing the Enemy##34336/1 |goto Gorgrond 41.6,40.6
	step
	...
	step
		...
		Speak to Chaluna |q The Giant Cauldron##34337/1 |goto Gorgrond 39.9,37.2
	step
		talk Thisalee Crow##78187
	...
	step
		...
		Take the Temperature of the Hissing Geyser |q Heating Up##34340/1 |goto Gorgrond/21 38.0,75.7
	step
		_Continue down_ the side passage |goto Gorgrond/21 46.6,54.1 < 15
		Investigate the Cauldron |q The Descent##34338/1 |goto Gorgrond/21 46.2,40.5
	step "gorenfeast"
		kill Dryback Acidroller##78255+, Dryback Devourer##78256+
		collect 8 Engorged Stomach##110278 |q A Goren's Feast##34339/1 |goto Gorgrond/21 55.1,76.1
	step
		kill Abyssal Earthwarden##78257 |q The Descent##34338/2 |goto Gorgrond/21 37.0,46.5
	step
		click Heart of Gorgorek##229161
		|tip It is a huge gold circular plate leaning against the cave wall.
		collect Heart of Gorgorek##110295 |q The Descent##34338/3 |goto Gorgrond/21 29.3,45.2
	step
		...
		Escape Belcher Cauldron |q The Descent##34338/4
	step
		talk Aren Mistshade##74125
...
ZygorGuidesViewer:RegisterInclude("H_Inn_Quests",[[
-- Auchindoun --
	step
	...
	step
		kill Teron'gor##77734 |q The Soulcutter##37156/2 |goto Auchindoun/0 49.6,33.5
		|tip Teron'gor is the final boss of the dungeon.
	step
		kill Teron'gor##77734 |q The Cure For Death##37154/2 |goto Auchindoun/0 49.6,33.5
		|tip Teron'gor is the final boss of the dungeon.
	step
		Leave the Dungeon
...
-- Bloodmaul Slag Mines --
	...
	step
		kill Gug'rokk##74790 |q Cro's Revenge##37152/2 |goto Bloodmaul Slag Mines/1 65.4,22.7
		|tip Gug'rokk is the final boss of the dungeon.
	step
		kill Gug'rokk##74790 |q Time-Lost Vikings##37153/2 |goto Bloodmaul Slag Mines/1 65.4,22.7
		|tip Gug'rokk is the final boss of the dungeon.
	step
		Leave the Dungeon
		|tip Click the green eye button on your minimap and choose "Leave Instance Group".
...
-- Everbloom --
	...
	step
		kill Yalnu##83846 |q Titanic Evolution##37166/2 |goto The Everbloom/2 47.0,67.0
		|tip Yalnu is the final boss of the dungeon.
	step
		kill Yalnu##83846 |q Cenarion Concerns##37165/2 |goto The Everbloom/2 47.0,67.0
		|tip Yalnu is the final boss of the dungeon.
	step
		kill Yalnu##83846 |q For the Birds##37150/2 |goto The Everbloom/2 47.0,67.0
		|tip Yalnu is the final boss of the dungeon.
	step
		Leave the Dungeon
		|tip Click the green eye button on your minimap and choose "Leave Instance Group".
...
-- Iron Docks --
	...
	step
		kill Skulloc##83612 |q The Brass Compass##37155/2 |goto Iron Docks/1 68.4,43.6
		|tip Skulloc is the final boss of the dungeon.
	step
		kill Skulloc##83612 |q Feeling A Bit Morose##37157/2 |goto Iron Docks/1 68.4,43.6
		|tip Skulloc is the final boss of the dungeon.
	step
		Leave the Dungeon
		|tip Click the green eye button on your minimap and choose "Leave Instance Group".
...
-- Shadowmoon Burial Grounds --
	...
	step
		...
		collect Dark Parchment##118625 |q Shadowy Secrets##37163/1 |goto Shadowmoon Burial Grounds/1 30.0,42.9
	step
		kill Ner'zhul##76407 |q The Void-Gate##37149/2 |goto Shadowmoon Burial Grounds/3 48.1,47.1
		|tip Ner'zhul is the final boss of the dungeon.
	step
		kill Ner'zhul##76407 |q The Huntresses##37164/2 |goto Shadowmoon Burial Grounds/3 48.1,47.1
		|tip Ner'zhul is the final boss of the dungeon.
	step
		kill Ner'zhul##76407 |q Shadowy Secrets##37163/2 |goto Shadowmoon Burial Grounds/3 48.1,47.1
		|tip Ner'zhul is the final boss of the dungeon.
	step
		Leave the Dungeon
		|tip Click the green eye button on your minimap and choose "Leave Instance Group".
...
-- Upper Blackrock Spire --
	...
	step
		kill Warlord Zaela##77120 |q Oralius' Adventure##37148/2 |goto Upper Blackrock Spire 2/3 14.1,47.7
		|tip Warlord Zaela is the final boss of the dungeon.
	step
		kill Warlord Zaela##77120 |q Family Traditions##37161/2 |goto Upper Blackrock Spire 2/3 14.1,47.7
		|tip Warlord Zaela is the final boss of the dungeon.
	step
		kill Warlord Zaela##77120 |q Damsels and Dragons##37162/2 |goto Upper Blackrock Spire 2/3 14.1,47.7
		|tip Warlord Zaela is the final boss of the dungeon.
	step
		kill Warlord Zaela##77120 |q For The Children!##37179/2 |goto Upper Blackrock Spire 2/3 14.1,47.7
		|tip Warlord Zaela is the final boss of the dungeon.
	step
		Leave the Dungeon
		|tip Click the green eye button on your minimap and choose "Leave Instance Group".
...
---- Old, use the Building Includes above
...
ZygorGuidesViewer:RegisterInclude("H_Garrison_LargeBuilding",[[
		talk %npc% |goto Frostwall/0 59.3,49.4 |only if garrisonlvl(1)
		talk %npc% |goto Frostwall/0 59.3,49.7 |only if garrisonlvl(2)
		talk %npc% |goto Frostwall/0 59.3,49.7 |only if garrisonlvl(3)
]])

ZygorGuidesViewer:RegisterInclude("H_Garrison_LargeBuilding_2",[[
...
ZygorGuidesViewer:RegisterInclude("H_Garrison_SmallBuilding",[[
		%action% |goto Frostwall/0 53.0,36.5 |only if ZGV.Garrison_GetBuildingLocation("%building%")==18
		%action% |goto Frostwall/0 48.3,33.0 |only if ZGV.Garrison_GetBuildingLocation("%building%")==19
		%action% |goto Frostwall/0 51.6,39.0 |only if ZGV.Garrison_GetBuildingLocation("%building%")==20
]])
