...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Spiritwalker",{
description="This guide will assist you in achieving the Spiritwalker Title.",
},[[
#include "wod_spiritwalker"
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Grimrail Suplexer",{
description="This guide will assist you in achieving the Grimrail Suplexer Title.",
},[[
#include "wod_grimrail suplexer"
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Violet Guardian",{
description="This guide will assist you in achieving the Violet Guardian Title.",
},[[
#include "wod_violet guardian"
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Lord/Lady of Blackrock",{
description="This guide will assist you in achieving the Lord/Lady of Blackrock Title.",
},[[
#include "wod_lord/lady of blackrock"
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Scion of Rukmar",{
description="This guide will assist you in achieving the Scion of Rukmar Title.",
},[[
#include "wod_scion of rukmar"
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Soul Preserver",{
description="This guide will assist you in achieving the Soul Preserver Title.",
},[[
#include "wod_soul preserver"
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Dockmaster",{
description="This guide will assist you in achieving the Dockmaster Title.",
},[[
#include "wod_dockmaster"
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Conservationist",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Spear of Vol'jin",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Field Photographer",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Timber Lord",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Southshore Slayer",{
description="This guide will assist you in achieving the Southshore Slayer Title.",
},[[
step
This title is no longer obtainable
|tip It was only available for a short time during the Southshore 40vs40 pvp event.
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Lumberjack",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Soldier of the Horde",{
description="This guide will assist you in achieving the Soldier of the Horde Title.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Guardian of the Horde",{
description="This guide will assist you in achieving the Guardian of the Horde Title.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Masked Chuckler",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Defender of the Horde",{
description="This guide will assist you in achieving the Defender of the Horde Title.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Wild Gladiator",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Warmongering Gladiator",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Primal Gladiator",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Savage Hero",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Predator",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Lord/Lady of War",{
...
step
#include "H_Garrison_Medium_Building", action="talk Gharg##87247", building="GladiatorSactum"
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\of the Jungle",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\of the Frostwolves",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Captain",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Titles\\Warlords of Draenor Titles\\Blood Champion",{
