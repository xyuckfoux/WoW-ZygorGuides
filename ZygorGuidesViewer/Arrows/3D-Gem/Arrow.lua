...
local arrowskindir,arrowskinlc,arrowskinname,arrowskinorder = "3DGem","3dgem","3D Gem","4"
...
function arrowframeproto:OnLoad()
	...
	arrow.warning = self.arrow:CreateAnimationGroup()
	local fade1 = ZGV.ChainCall(arrow.warning:CreateAnimation("Alpha")) :SetDuration(0.5) :SetToAlpha(1)  :SetOrder(1) .__END
	local fade2 = ZGV.ChainCall(arrow.warning:CreateAnimation("Alpha")) :SetDuration(0.5) :SetToAlpha(0) :SetOrder(2) .__END
