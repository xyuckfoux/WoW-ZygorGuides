...
|only if havequest(39800) or completedq(39800)
step
click Skyfire Parachute |goto 48.28,16.94 |n
|tip Downstairs in the airship. Follow the bouncing white arrows.
Parachute Onto the Boat |goto 52.86,38.86 < 30 |noway |c |q 39800
|only if havequest(39800) or completedq(39800)
step
...
accept From Within##40815 |or |goto 43.55,43.47
step
...
turnin From Within##40815 |goto 41.24,50.51 |only if havequest(40815) or completedq(40815)
...
step
click Skyfire Medical Supplies
collect Skyfire First Aid Kit##123876 |q 38036/1 |count 3 |goto 35.01,53.52
step
...
step
click Skyfire Medical Supplies
collect Skyfire First Aid Kit##123876 |q 38036/1 |count 4 |goto 35.23,54.39
step
Follow the path |goto 35.10,53.77 < 10 |only if walking
click Skyfire Medical Supplies
collect Skyfire First Aid Kit##123876 |q 38036/1 |count 5 |goto 34.83,54.33
step
...
accept A Worthy Challenger##38442 |goto 43.17,49.16 |only if level < 110
...
step
Kill Duskpelt enemies around this area
Slay #10# Duskpelt Worgs |q 39789/1 |goto 47.46,56.64
step
...
Follow the path |goto 55.47,67.87 < 30 |only if walking
Follow the path |goto 56.79,71.53 < 30 |only if walking
