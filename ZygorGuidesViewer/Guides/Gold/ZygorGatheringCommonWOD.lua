...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Gold Ore",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=115},levelreq=45},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Iron Ore/Heavy Stone",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=100},levelreq=35},
	items={{2775,16},{2838,860},{2772,728},{3858,20},{7912,20},{1529,8},{3864,8}},
	maps={"Feralas"},
},[[
	step
		model Iron Deposit##312
		map Feralas
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Mithril Ore/Solid Stone",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=150},levelreq=44},
	items={{7912,620},{3858,604},{7911,40},{2776,40},{3864,16},{7910,8}},
	maps={"Badlands"},
},[[
	step
		model Mithril Vein##313
		map Badlands
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Thorium Ore/Dense Stone/Truesilver Ore",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=215},levelreq=50},
	items={{7910,16},{12365,944},{10620,744},{12363,24},{12800,8},{12361,4},{12364,4},{12799,8},{7911,44},{2776,24}},
	maps={"Winterspring"},
},[[
	step
		model Small Thorium Vein##3951
		model Rich Thorium Vein##3952
		model Truesilver Deposit##314
		map Winterspring
		path	follow loose; loop on; ants curved; dist 20
		path	68.0,54.3
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Adamantite Ore/Eternium Ore/Khorium Ore",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=325},levelreq=64},
	items={{23427,20},{23425,252},{22573,160},{23424,76},{22574,40},{23426,32}},
	maps={"Nagrand"},
},[[
	step
		model Adamantite Deposit##6798
		model Rich Adamantite Deposit##6798
		model Khorium Deposit##6800
		map Nagrand
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Fel Iron Ore",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=275},levelreq=58},
	items={{23424,320},{22573,64},{22574,56},{23427,4}},
	maps={"Hellfire Peninsula"},
},[[
	step
		model Fel Iron Deposit##6799
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Cobalt Ore",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=350},levelreq=74},
	items={{37701,20},{36909,320},{37705,56}},
	maps={"Zul'Drak"},
},[[
	step
		model Cobalt Deposit##7881
		model Rich Cobalt Deposit##7881
		map Zul'Drak
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Saronite Ore",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=400},levelreq=76},
	items={{36912,440},{36910,12},{37701,104},{37703,100},{37705,16}},
	maps={"Sholazar Basin"},
},[[
	step
		model Saronite Deposit##7804
		model Rich Saronite Deposit##7804
		map Sholazar Basin
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Titanium Ore",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=450},levelreq=77},
	items={{36912,312},{36910,96},{37701,176},{37703,80},{37705,48},{37700,24},{37702,24}},
	maps={"Icecrown"},
},[[
	step
		model Titanium Vein##6798
		map Icecrown
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Elementium Ore/Pyrite Ore",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=475},levelreq=84},
	items={{52185,444},{52327,52},{52183,84},{52325,8}},
	maps={"Twilight Highlands"},
},[[
	step
		model Elementium Vein##10157
		model Rich Elementium Vein##10158
		model Pyrite Deposit##10155
		model Rich Pyrite Deposit##10156
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Obsidium Ore",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=425},levelreq=82},
	items={{53038,488},{52327,58}},
	maps={"Deepholm"},
},[[
	step
		model Obsidium Deposit##10159
		model Rich Obsidium Deposit##10160
		map Deepholm
		path	follow smart; loop on; ants curved; dist 10
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Black Trillium Ore/White Trillium Ore",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=600},levelreq=88},
	items={{72092,552},{72093,40},{72094,44},{72103,44}},
	maps={"Townlong Steppes"},
},[[
	step
		model Trillium Vein##11732
		model Rich Trillium Vein##11733
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Ghost Iron Ore",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=500},levelreq=85},
	items={{72092,724}},
	maps={"The Jade Forest"},
},[[
	step
		model Ghost Iron Deposit##11314
		model Rich Ghost Iron Deposit##11315
		map The Jade Forest
		path	follow smart; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Kyparite",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=550},levelreq=89},
	items={{72092,92},{72093,212}},
	maps={"Dread Wastes"},
},[[
	step
		model Kyparite Deposit##11312
		model Rich Kyparite Deposit##11313
		map Dread Wastes
		path	follow smart; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Blackrock/True Iron Ore",{
	meta={goldtype="route",skillreq={mining=1,miningcrapuntil=600},levelreq=90},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Deviate Fish",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=1},levelreq=10},
	items={{6522,184}},
	maps={"Northern Barrens"},
},[[
	step
		model School of Deviate Fish##6291 
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Oily Blackmouth/Firefin Snapper/Stonescale Eel",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=1},levelreq=52},
	items={{6358,52},{6359,44},{13422,64}},
	maps={"Swamp of Sorrows"},
},[[
	step
	label "route_1"
		model Oily Blackmouth School##6291
		model Pool of Firefin Snapper##6482
		model Stonescale Eel Swarm##6742
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Glassfin Minnow/Pygmy Suckerfish",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=1},levelreq=77},
	items={{41814,156},{40199,48}},
	maps={"Crystalsong Forest"},
},[[
	step
	label "route_1"
		model Glassfin Minnow School##6482
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Albino Cavefish",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=1},levelreq=82},
	items={{53065,148},{52326,24}},
	maps={"Deepholm"},
},[[
	step
	label "route_1"
		model Albino Cavefish School##6482
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Emperor Salmon/Krasarang Paddlefish",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=1},levelreq=86},
	items={{74859,96},{74865,96}},
	maps={"Valley of the Four Winds"},
},[[
	step
	label "route_1"
		model Emperor Salmon School##6482
		model Krasarang Paddlefish School##6435
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Giant Mantis Shrimp/Reef Octopus",{
	...
	step
	label "route_1"
		model Reef Octopus Swarm##6291
		model Giant Mantis Shrimp Swarm##6742
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Golden Carp",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=650},levelreq=85},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Jade Lungfish",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=1},levelreq=85},
	items={{74856,208},{88496,8}},
	maps={"The Jade Forest"},
},[[
	step
	label "route_1"
		model Jade Lungfish School##6435
		Use your Fishing skill to fish in any pools you find |cast Fishing##131474
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Jewel Danio",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=1},levelreq=90},
	items={{74863,212},{88496,4}},
	maps={"Timeless Isle"},
},[[
	step
		model Jewel Danio School##6291
		Use your Fishing skill to fish in any pools you find |cast Fishing##131474
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Redbelly Mandarin/Emperor Salmon",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=1},levelreq=88},
	items={{74860,74},{74859,74}},
	maps={"Townlong Steppes"},
},[[
	step
	label "route_1"
		model Redbelly Mandarin School##6482
		model Emperor Salmon School##6482
		Use your Fishing skill to fish in any pools you find |cast Fishing##131474
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Spinefish",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=1},levelreq=87},
	items={{83064,172}},
	maps={"Kun-Lai Summit"},
},[[
	step
		model Spinefish School##6291
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Tiger Gourami/Golden Carp",{
	...
	step
	label "route_1"
		model Tiger Gourami School##6482
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Abyssal Gulper Eel Flesh/Crescent Saberfish Flesh",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=600},levelreq=96},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Abyssal Gulper Eel Flesh",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=1},levelreq=96},
	...
	step
	label "route_1"
		model Abyssal Gulper School##6435
		Use your Worm Supreme lure |use Worm Supreme##118391 
		|tip You can buy this cheap from the auction house or get it randomly fishing in Draenor.
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Blackwater Whiptail Flesh/Crescent Saberfish Flesh",{
	meta={goldtype="route",skillreq={fishing=1,fishingcrapuntil=1},levelreq=94},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Blackwater Whiptail Flesh",{
	...
	step
		model Blackwater Whiptail School##6435
		Use your Worm Supreme lure |use Worm Supreme##118391 
		|tip You can buy this cheap from the auction house or get it randomly fishing in Draenor.
		Follow the path, fishing at any pools
		Use your Fishing skill to fish in the water |cast Fishing##131474
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Blind Lake Sturgeon Flesh/Crescent Saberfish Flesh",{
	meta={goldtype="route",skillreq={fishing=600,fishingcrapuntil=1},levelreq=90},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Blind Lake Sturgeon Flesh",{
	...
	step
	label "route_1"
		model Blind Lake Sturgeon School##6435
		Use your Worm Supreme lure |use Worm Supreme##118391 
		|tip You can buy this cheap from the auction house or get it randomly fishing in Draenor.
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Fat Sleeper Flesh/Crescent Saberfish Flesh",{
	meta={goldtype="route",skillreq={fishing=600,fishingcrapuntil=1},levelreq=98},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Jawless Skulker Flesh/Crescent Saberfish Flesh",{
	meta={goldtype="route",skillreq={fishing=600,fishingcrapuntil=1},levelreq=92},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Sea Scorpion Segment",{
	meta={goldtype="route",skillreq={fishing=600,fishingcrapuntil=1},levelreq=96},
	...
	step
	label "route_1"
		model Sea Scorpion School##6435
		Use your Worm Supreme lure |use Worm Supreme##118391 
		|tip You can buy this cheap from the auction house or get it randomly fishing in Draenor.
...
--Arthas' Tears is not used by any recipes anymore
--ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Arthas' Tears/Grave Moss",[[
--	meta goldtype="route",skillreq={herbalism=220},levelreq={42,45},elitemobs=1
--	step
--		map Razorfen Downs/1
--		path	follow smart; loop off; ants curved; dist 10
--		path	31.3,45.0	24.4,60.2	43.9,77.8
--		path	54.5,66.4	35.8,53.7	42.6,67.3
--		path	42.3,57.1	36.6,44.7	71.7,41.8
--		path	87.5,46.0	75.6,28.8	67.1,32.1
--		path	57.8,31.6	51.8,36.7
--		goldcollect 24 Arthas' Tears##8836
--		goldcollect 132 Grave Moss##3369
--		goldtracker
--		Click here to sell items |confirm
--	step
--		#include "auctioneer"
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Blindweed",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=235},levelreq=45},
	items={{3818,68},{8839,332},{3358,56}},
	maps={"Feralas"},
},[[
	step
		model Blindweed##2311
		map Feralas
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Bruiseweed",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=1},levelreq=25},
	items={{3356,270},{2453,204},{3355,84}},
	maps={"Northern Stranglethorn"},
},[[
	step
		model Bruiseweed##358
		map Northern Stranglethorn
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Dragon's Teeth",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=195},levelreq=44},
	items={{3819,84},{8838,16},{13464,12},{4625,4}},
	maps={"Badlands"},
},[[
	step
		model Dragon's Teeth##10249
		map Badlands
		path	follow loose; loop on; ants curved; dist 10
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Dreamfoil/Black Lotus (54-95)",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=270},levelreq=54},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Dreamfoil/Black Lotus (96-100)",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=270},levelreq=96},
	items={{13463,280},{13464,24},{13465,20}},
	maps={"Blasted Lands"},
},[[
	step
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Fadeleaf",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=150},levelreq=45},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Firebloom",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=205},levelreq=47},
	items={{4625,224},{8838,172}},
	maps={"Searing Gorge"},
},[[
	step
		model Firebloom##2312
		map Searing Gorge
		path	follow smart; loop on; ants curved; dist 10
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Ghost Mushroom (Un'Goro Crater)",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=245},levelreq=50},
	items={{8845,152}},
	maps={"Un'Goro Crater"},
},[[
	step
		model Ghost Mushroom##389
		map Un'Goro Crater
		path follow loose; loop on; ants curved; dist 10
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Ghost Mushroom (Zangarmarsh - Outland)",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=245},levelreq=60},
	items={{8845,108}},
	maps={"Zangarmarsh"},
},[[
	step
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Golden Sansam",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=260},levelreq=52},
	items={{13464,476},{13466,348}},
	maps={"Swamp of Sorrows"},
},[[
	step
		model Golden Sansam##4652
		map Swamp of Sorrows
		path	follow loose; loop on; ants curved; dist 15
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Grave Moss",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=105},levelreq=20},
	items={{3369,32}},
	maps={"Duskwood"},
},[[
	step
	label "Farm 1"
		model Grave Moss##357
		map Duskwood
		path	follow loose; loop on; ants curved; dist 15
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Gromsblood",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=250},levelreq=45},
	items={{8846,368},{8831,48},{13464,184},{13463,64}},
	maps={"Felwood"},
},[[
	step
		model Gromsblood##2313
		map Felwood
		path	follow loose; loop on; ants curved; dist 25
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Icecap",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=270},levelreq=50},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Khadgar's Whisker",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=160},levelreq=40},
	items={{8838,300},{3357,52},{3358,380}},
	maps={"Eastern Plaguelands"},
},[[
	step
		model Khadgar's Whisker##701
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Kingsblood",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=125},levelreq=25},
	items={{3356,448},{2453,28},{3355,28}},
	maps={"Northern Stranglethorn"},
},[[
	step
		model Kingsblood##320
		map Northern Stranglethorn
		path	follow loose; loop on; ants curved; dist 25
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Liferoot",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=150},levelreq=40},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Mageroyal",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=1},levelreq=20},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Mountain Silversage",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=280},levelreq=50},
	items={{13467,112},{13465,280}},
	maps={"Winterspring"},
},[[
	step
		model Mountain Silversage##4633
		map Winterspring/0
		path	follow loose; loop on; ants curved; dist 10
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Purple Lotus/Wildvine",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=210},levelreq=45},
	items={{8153,12},{8831,144},{13463,36},{8846,256},{13464,220}},
	maps={"Felwood"},
},[[
	step
		model Purple Lotus##2314
		map Felwood
		path	follow loose; loop on; ants curved; dist 10
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Sorrowmoss",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=285},levelreq=52},
	items={{13466,440},{13464,300}},
	maps={"Swamp of Sorrows"},
},[[
	step
		model Sorrowmoss##4632
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Stranglekelp",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=85},levelreq=40},
	items={{3820,360}},
	maps={"Thousand Needles"},
},[[
	step
		model Stranglekelp##700
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Sungrass",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=230},levelreq=40},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Ancient Lichen",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=340},levelreq=61},
	items={{22790,122}},
	maps={"Mana-Tombs"},
},[[
	step
		model Ancient Lichen##6967
		map Mana-Tombs
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Dreaming Glory",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=315},levelreq=64},
	items={{22786,168},{22785,80},{22575,76},{22793,12},{22794,4}},
	maps={"Nagrand"},
},[[
	step
		model Dreaming Glory##6948
		map Nagrand/0
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Felweed",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=300},levelreq=58},
	...
	step
		...
		path	follow loose; loop on; ants curved; dist 25
		path	47.746.5	51.6,52.5	48.8,59.1
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Mana Thistle",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=375},levelreq=62},
	items={{22793,76},{22786,104},{22575,20}},
	maps={"Shadowmoon Valley","Terokkar Forest"},
},[[
	step
	label "Path 1"
		model Mana Thistle##6945
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Netherbloom",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=350},levelreq=67},
	items={{22791,212},{22786,84},{22576,24},{22794,8},{22575,10}},
	maps={"Netherstorm"},
},[[
	step
		model Netherbloom##6947
		map Netherstorm
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Nightmare Vine",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=365},levelreq=67},
	items={{22792,168},{22794,4},{22785,116},{22789,52},{22786,32}},
	maps={"Shadowmoon Valley"},
},[[
	step
		model Nightmare Vine##6946
		map Shadowmoon Valley
		path	follow smart; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Ragveil",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=325},levelreq=60},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Terocone",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=325},levelreq=62},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Adder's Tongue",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=400},levelreq=76},
	items={{37704,232},{36903,416},{36904,136},{36901,112},{37921,96},{36908,20}},
	maps={"Sholazar Basin"},
},[[
	step
		model Adder's Tongue##8084
		map Sholazar Basin
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Fire Leaf",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=360},levelreq=68},
	items={{39970,330},{37702,72},{36908,12},{36901,30},{37921,12}},
	maps={"Borean Tundra"},
},[[
	step
		model Firethorn##2313
		map Borean Tundra
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Goldclover/Deadnettle",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=350},levelreq=68},
	items={{36901,344},{36904,16},{37921,68},{37704,108},{36908,12}},
	maps={"Howling Fjord"},
},[[
	step
		model Goldclover##7844
		map Howling Fjord/0
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Icethorn/Lichbloom",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=435},levelreq=77},
	items={{36905,336},{36906,280},{37704,128},{36908,12}},
	maps={"The Storm Peaks"},
},[[
	step
		model Icethorn##8086
		model Lichbloom##8087
		map The Storm Peaks
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Talandra's Rose",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=385},levelreq=74},
	items={{36907,344},{37921,120},{36908,12},{37704,80}},
	maps={"Zul'Drak"},
},[[
	step
		model Talandra's Rose##7865
		map Zul'Drak
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Tiger Lily/Deadnettle",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=375},levelreq=76},
	items={{36904,388},{36903,128},{36908,20},{37921,152},{37704,208},{36901,24}},
	maps={"Sholazar Basin"},
},[[
	step
		model Tiger Lily##7864
		map Sholazar Basin
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Azshara's Veil",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=425},levelreq=80},
	items={{52985,332},{52984,112},{52329,152},{63122,12}},
	maps={"Shimmering Expanse"},
},[[
	step
		model Azshara's Veil##10255
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Heartblossom/Cinderbloom",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=425},levelreq=82},
	items={{52986,168},{52983,180},{52329,88},{63122,8}},
	maps={"Deepholm"},
},[[
	step
		model Heartblossom##10266
		model Cinderbloom##10256
		map Deepholm
		path	follow smart; loop on; ants curved; dist 10
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Twilight Jasmine",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=525},levelreq=84},
	items={{52987,352},{52329,116},{52983,48},{63122,8}},
	maps={"Twilight Highlands"},
},[[
	step
		model Twilight Jasmine##10258
		map Twilight Highlands
		path	follow loose; loop on; ants curved; dist 15
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Whiptail",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=500},levelreq=83},
	items={{52988,640},{52329,208},{63122,12}},
	maps={"Uldum"},
},[[
	step
		model Whiptail##10259
		map Uldum
		path	follow loose; loop on; ants curved; dist 15
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Fool's Cap",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=600},levelreq=89},
	items={{72234,68},{79011,172},{89640,8},{89641,4}},
	maps={"Dread Wastes"},
},[[
	step
		model Fool's Cap##12424
		map Dread Wastes
		path	follow loose; loop on; ants curved; dist 15
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Green Tea Leaf",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=500},levelreq=85},
	items={{72234,740},{72237,60},{89640,80},{72238,12}},
	maps={"The Jade Forest"},
},[[
	step
		model Green Tea Leaf##12429
		map The Jade Forest
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Silkweed",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=545},levelreq=86},
	items={{72235,520},{72234,204},{89640,52}},
	maps={"Valley of the Four Winds"},
},[[
	step
		model Silkweed##12432
		map Valley of the Four Winds
		path	follow smart; loop on; ants curved; dist 10
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Snow Lily",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=575},levelreq=87},
	items={{79010,736},{89640,20},{89641,40}},
	maps={"Kun-Lai Summit"},
},[[
	step
		model Snow Lily##12433
		map Kun-Lai Summit
		path	follow loose; loop on; ants curved; dist 20
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Frostweed",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=600},levelreq=90},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Gorgrond Flytrap",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=600},levelreq=92},
	items={{109126,240}},
	maps={"Gorgrond"},
},[[
	step
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Nagrand Arrowbloom",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=600},levelreq=98},
	items={{109128,404}},
	maps={"Nagrand D"},
},[[
	step
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Talador Orchid",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=600},levelreq=94},
	items={{109129,576}},
	maps={"Talador"},
},[[
	step
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Dusky Pigment/Verdant Pigment",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=1,inscription=25},levelreq=20},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Golden Pigment/Burnt Pigment",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=125,inscription=75},levelreq=25},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Emerald Pigment/Indigo Pigment",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=230,inscription=175},levelreq=40},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Violet Pigment/Ruby Pigment",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=235,inscription=175},levelreq=35},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Silvery Pigment/Sapphire Pigment",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=280,inscription=225},levelreq=50},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Nether Pigment/Ebon Pigment",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=365,inscription=275},levelreq=67},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Azure Pigment/Icy Pigment",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=435,inscription=325},levelreq=77},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Ashen Pigment/Burning Embers",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=500,inscription=450},levelreq=83},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Misty Pigment/Shadow Pigment",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=500,inscription=500},levelreq=85},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Cerulean Pigment",{
	meta={goldtype="route",skillreq={herbalism=1,herbalismcrapuntil=600,inscription=1},levelreq=94},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Deviate Scale/Perfect Deviate Scale",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=65},levelreq=10},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Heavy Leather/Heavy Hide",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=185},levelreq=45},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Thick Leather",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=235},levelreq=44},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Rugged Leather/Rugged Hide (Onyxia's Lair)",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=435},levelreq=90,elitemobs=1},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Rugged Leather",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=285},levelreq=52},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Turtle Scale/Thick Leather",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=250},levelreq=52},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Knothide Leather (Karazhan)",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=355},levelreq=80},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Knothide Leather",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=350},levelreq=62},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Borean Leather (Gundrak)",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=405},levelreq=90},
	items={{33568,450}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Borean Leather",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=405},levelreq=74},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Savage Leather/Pristine Hide (Tol Barad)",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=490},levelreq=85},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Savage Leather/Pristine Hide (Twilight Highlands)",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=470},levelreq=84},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Exotic Leather",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=590},levelreq=90},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Raw Beast Hide",{
	meta={goldtype="route",skillreq={skinning=1,skinningcrapuntil=600},levelreq=98},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Black Whelp Scale",{
	meta={goldtype="route",skillreq={skinning=120},levelreq=24},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Warbear Leather",{
	meta={goldtype="route",skillreq={skinning=290},levelreq=58},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Scorpid Scale",{
	meta={goldtype="route",skillreq={skinning=235},levelreq=47},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Devilsaur Leather",{
	meta={goldtype="route",skillreq={skinning=275},levelreq=55,elitemobs=1},
	items={{15417,240}},
	maps={"Un'Goro Crater"},
},[[
	step
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Wind Scale/Knothide Leather",{
	meta={goldtype="route",skillreq={skinning=335},levelreq=67},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Nether Dragonscales",{
	meta={goldtype="route",skillreq={skinning=350},levelreq=70},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Thick Clefthoof Leather",{
	meta={goldtype="route",skillreq={skinning=325},levelreq=65},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Cobra Scale",{
	meta={goldtype="route",skillreq={skinning=350},levelreq={68,70}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Fel Hide",{
	meta={goldtype="route",skillreq={skinning=340},levelreq=67},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Icy Dragonscale/Arctic Fur",{
	meta={goldtype="route",skillreq={skinning=385},levelreq=76},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Nerubian Chitin",{
	meta={goldtype="route",skillreq={skinning=380},levelreq=75},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Jormungar Scale",{
	meta={goldtype="route",skillreq={skinning=400},levelreq=79},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Deepsea Scale/Savage Leather",{
	meta={goldtype="route",skillreq={skinning=400},levelreq=80},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Blackened Dragonscale",{
	meta={goldtype="route",skillreq={skinning=425},levelreq=85},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Prismatic Scale",{
	meta={goldtype="route",skillreq={skinning=440},levelreq={87,88}},
