...
ZygorGuidesViewer:RegisterInclude("FrenzyheartPreQuests",[[
	...
	step
		kill Pitch##28097
		collect Pitch's Remains |q The Part-time Hunter##12654/1 |goto 50.5,77.3
	step
	...
	step
		...
		collect Stinger of the Sapphire Queen |q The Sapphire Queen##12534/1
	step
	...
	step
		...
		collect 8 Skyreach Crystal Cluster |q Mischief in the Making##12535/1 |goto 56.6,84.6
	step
		kill Serfex the Reaver##28083
		collect Claw of Serfex |q The Underground Menace##12531/1 |goto 49.8,85
	step		
		talk High-Shaman Rakjak##28082
	...
	step
		...
		collect 6 Shiny Treasures |q Gods like Shiny Things##12572/1 |goto 52.4,53.2
	...
	step
		...
		collect Mistwhisper Treasure |q The Lost Mistwhisper Treasure##12575/2 |goto 41.6,19.5
	step
		talk Mistcaller Soo-gan##28114
	...
	step
		...
		collect 10 Lifeblood Shard |q Lifeblood of the Mosswalker Shrine##12579/1 |goto 68.9,54.6
	step
...
ZygorGuidesViewer:RegisterInclude("FrenzyheartDailies",[[
	...
	step
		...
		Click the Chicken Escapees
		collect 12 Captured Chicken |q Chicken Party!##12702/1
	step
	...
	step
		...
		collect Stormwatcher's Head |q A Hero's Headgear##12758/1 |goto 26.0,35.4
	step
	...
	step
		...
		collect Suntouched Heartblood |q The Heartblood's Strength##12732/1 |goto 33.8,52.1
	step
	...
	step
		...
		collect Secret Strength of the Frenzyheart |q Secret Strength of the Frenzyheart##12760/2 |goto 26.8,60.1
	step
...
ZygorGuidesViewer:RegisterInclude("OracleDailies",[[
	...
	step
		...
		Lafoo will dig up the treasure
		Click the random items that appear on the ground
		collect 6 Shiny Treasures|q Appeasing the Great Rain Stone##12704/1 |goto 52.4,53.2
	step
	...
	step		
		...
		collect Energized Polished Crystal |q Power of the Great Ones##12762/2 |goto 65.5,60.2
	step
...
ZygorGuidesViewer:RegisterInclude("CleansingDrakTharon",[[
	...
	step		
		talk Ameenah##26474
		buy 1 Crystal Vial |q Vial of Visions##11990/1 |goto 16,47.8
	step
		Click the Hazewood Bushes
		|tip They look like small flower bushes on the ground around this area.
		collect 3 Haze Leaf|q Vial of Visions##11990/2 |goto 14.6,45.3
	step		
		Click a Waterweed|tip They look like big green bushes underwater around this area.
		collect Waterweed Frond|q Vial of Visions##11990/3 |goto 15.2,40.3
	step
		talk Drakuru##26423
	...
	step		
		...
		collect Eye of the Prophets|q Sacrifices Must be Made##12007/1 |goto 17.9,36.5
	...
	step
		...
		collect Drakkari Tablets|q Voices From the Dust##12068/1
	step
		Use Drakuru's Elixir next to Drakuru's Brazier |use Drakuru's Elixir##35797
...
ZygorGuidesViewer:RegisterInclude("BetrayalDrakuru",[[
	...
	step
		...
		collect 5 Putrid Abomination Guts |q Silver Lining##12643/1 |goto 19.9,73.5 |or
		Click the Gooey Ghoul Drool on the ground
		|tip They look like jelly blobs on the ground around this area.
		collect 5 Gooey Ghoul Drool |q Silver Lining##12643/2 |goto 19.9,73.5
	step
		talk Stefan Vadu##28518
	...
	step		
		...
		buy 1 Bitter Plasma|q Suit Up!##12649/1 |goto 19.9,75.5
	step
		talk Stefan Vadu##28518
	...
	step
		...
		collect 5 Harvested Blight Crystal |q Hazardous Materials##12677/2 |goto 27.1,43.9
	step
		Teleport back down to the ground |goto 28.0,44.9		
