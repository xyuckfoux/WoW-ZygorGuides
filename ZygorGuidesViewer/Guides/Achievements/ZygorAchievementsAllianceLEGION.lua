...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\A Classy Outfit",{
...
Click here load the "Class Order Hall" guide |confirm |next "Zygor's Alliance Leveling Guides\\Legion (100-110)\\Order Hall Quests" |or
...
Click here load the "Suramar" guide |confirm |next "Zygor's Alliance Leveling Guides\\Legion (100-110)\\Suramar (110)" |or
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\A Glorious Campaign",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\A Heroic Campaign",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\An Epic Campaign",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Arsenal of Power",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Artifact or Artifiction",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Broken Isles Pathfinder, Part One",{
...
Click here to load the "Broken Isles Explorer" guide |confirm |next "Zygor's Alliance Achievement Guides\\Exploration\\Legion\\Broken Isles Explorer" |or
step
...
Click here to load the "Loremaster of Legion" guide |confirm |next "Zygor's Alliance Achievement Guides\\Quests\\Legion\\Loremaster of Legion" |or
step
...
Click here to load the "Variety is the Spice of Life" guide |confirm |next "Zygor's Alliance Achievement Guides\\Quests\\Legion\\Variety is the Spice of Life" |or
step
...
Click here to load the "Broken Isles Diplomat" guide |confirm |next "Zygor's Alliance Achievement Guides\\Reputation\\Legion\\Broken Isles Diplomat" |or
step
...
Click here to load the "A Glorious Campaign" guide |confirm |next "Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\A Glorious Campaign" |or
step
_Congratulations!_
You have earned the _Broken Isles Pathfinder, Part One_ achievement
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Champions Rise",{
...
Click here to load the "Class Order Hall Quests" guide |confirm |next "Zygor's Alliance Leveling Guides\\Legion (100-110)\\Order Hall Quests" |or
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Fighting with Style: Classic",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Forged for Battle",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Improving on History",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Lead a Legion",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Legendary Research",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Many Many Missions, Handle It!",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Many Missions",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Need Backup",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Part of History",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Power Realized",{
...
Click here to access "World Quests" guide |confirm |next "Zygor's Alliance Dailies Guides\\Legion\\World Quests" |or
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Raise an Army",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Roster of Champions",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\So Many Missions",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\There's a Boss In There",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Class Order Hall\\Legion\\Training the Troops",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Dungeons\\Legion\\One Night in Karazhan",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Dungeons\\Legion\\The Rat Pack",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Dungeons\\Legion\\Scared Straight",{
...
Click here to load the "Millhouse Manastorm" follower guide |confirm |next "Zygor's Alliance Leveling Guides\\Draenor (90-100)\\Garrisons\\Followers\\Follower Millhouse Manastorm"
Click here to continue |confirm
step
...
Click here to load the "Legion Brawler's Guild" guide |confirm |next "Zygor's Alliance Events Guides\\Brawler's Guild\\Legion Brawler's Guild"
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\General\\Wrath of the Lich King\\Needy",{
...
Click here to load the "Fishing Quest Line" guide |confirm |next "Zygor's Alliance Profession Guides\\Fishing\\Legion\\Fishing Quest Line" |or
step
...
Click here to load the "A Cast Above the Rest" achievement guide |confirm |next "Zygor's Alliance Achievement Guides\\Professions\\Fishing\\A Cast Above the Rest"
step
Follow the path |goto Dalaran L/10 38.13,45.34 < 20 |only if walking
Follow the path |goto Dalaran L/10 30.75,32.64 < 20 |only if walking
Jump off toward the floating island |goto Dalaran L/10 26.22,20.40 < 20 |only if walking
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Quests\\Legion\\Insurrection",{
...
Click here to load the "What a Ripoff!" guide |confirm |next "Zygor's Alliance Achievement Guides\\Quests\\Legion\\What a Ripoff!"
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Quests\\Legion\\Pillars of Creation",{
...
|tip Use the "World Quests" guide to accomplish this.
Click here to load the "World Quests" guide |confirm |next "Zygor's Alliance Dailies Guides\\Legion\\World Quests" |or
step
_Congratulations!_
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Arcing Aqueducts",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Betrayer's Rise",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Boneafide Tri Tip",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Buggy Fight",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Cage Rematch",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\The Chosen",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Darkbough",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Elementalry!",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Fruit of All Evil",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Gluten Free",{
condition_end="achieved(10742)",
author="support@zygorguides.com",
startlevel=110,
endlevel=110,
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Grand Opening",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\I Attack the Darkness",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\I've Got My Eyes On You",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Imagined Dragons World Tour",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Infinitesimal",{
condition_end="achieved(10699)",
author="support@zygorguides.com",
startlevel=110,
endlevel=110,
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Cenarius",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Chronomatic Anomaly",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Dragons of Nightmare",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Elerethe Renferal",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Grand Magistrix Elisande",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Guarm",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Gul'dan",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Helya",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: High Botanist Tel'arn",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Il'gynoth",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Krosus",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Nythendra",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Odyn",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Skorpyron",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Spellblade Aluriel",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Star Augur Etraeus",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Tichondrius",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Trilliax",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Ursoc",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Mythic: Xavius",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Nightspire",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Not For You",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Patient Zero",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Rift of Aln",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Royal Athenaeum",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Scare Bear",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Took the Red Eye Down",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Tormented Guardians",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Trial of Valor",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Unleashed Monstrosities",{
...
Click here to load the "Unlock World Quests" guide |confirm |next "Zygor's Alliance Dailies Guides\\Legion\\World Quests Unlock Quest Line"
Click here to load the "World Quests" guide |confirm |next "Zygor's Alliance Dailies Guides\\Legion\\World Quests"
Here is your progress:
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Use the Force(s)",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\Webbing Crashers",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Raid\\Legion\\You Ruined Everything!",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Achievement Guides\\Reputation\\Legion\\The Nightfallen",{
...
Click here to load the "Suramar" guide |confirm |next |next "Zygor's Alliance Leveling Guides\\Legion (100-110)\\Suramar (110)"
Click here to load the "World Quests" guide |confirm |next |next "Zygor's Alliance Dailies Guides\\Legion\\World Quests"
